...
void update_onscreen()
{
	...
	else
	{
	  SDL_ANDROID_SetScreenKeyboardShown(1);
	    ...
	    pos_textinput.x = currprefs.pos_x_textinput*(SDL_ListModes(NULL, 0)[0]->w/(float)480);
	    pos_textinput.y = currprefs.pos_y_textinput*(SDL_ListModes(NULL, 0)[0]->h/(float)360);
	    ...
	    pos_dpad.x = currprefs.pos_x_dpad*(SDL_ListModes(NULL, 0)[0]->w/(float)480);
	    pos_dpad.y = currprefs.pos_y_dpad*(SDL_ListModes(NULL, 0)[0]->h/(float)360);
	    ...
	    pos_button1.x = currprefs.pos_x_button1*(SDL_ListModes(NULL, 0)[0]->w/(float)480);
	    pos_button1.y = currprefs.pos_y_button1*(SDL_ListModes(NULL, 0)[0]->h/(float)360);
	    ...
	    pos_button2.x = currprefs.pos_x_button2*(SDL_ListModes(NULL, 0)[0]->w/(float)480);
	    pos_button2.y = currprefs.pos_y_button2*(SDL_ListModes(NULL, 0)[0]->h/(float)360);
	    ...
	    pos_button3.x = currprefs.pos_x_button3*(SDL_ListModes(NULL, 0)[0]->w/(float)480);
	    pos_button3.y = currprefs.pos_y_button3*(SDL_ListModes(NULL, 0)[0]->h/(float)360);
	    ...
	    pos_button4.x = currprefs.pos_x_button4*(SDL_ListModes(NULL, 0)[0]->w/(float)480);
	    pos_button4.y = currprefs.pos_y_button4*(SDL_ListModes(NULL, 0)[0]->h/(float)360);
	    ...
	    pos_button5.x = currprefs.pos_x_button5*(SDL_ListModes(NULL, 0)[0]->w/(float)480);
	    pos_button5.y = currprefs.pos_y_button5*(SDL_ListModes(NULL, 0)[0]->h/(float)360);
	    ...
	    pos_button6.x = currprefs.pos_x_button6*(SDL_ListModes(NULL, 0)[0]->w/(float)480);
	    pos_button6.y = currprefs.pos_y_button6*(SDL_ListModes(NULL, 0)[0]->h/(float)360);
