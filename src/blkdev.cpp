...
static int scsi_cd_emulate (int unitnum, uae_u8 *cmdbuf, int scsi_cmd_len,
...
static int sys_command_scsi_direct_native(int unitnum, int type, struct amigascsi *as)
{
	struct blkdevstate *st = &state[unitnum];
